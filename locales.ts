...
export const TRANSLATIONS = {
  ...
  zh: {
    ui: {
      ...
      regular: "规则",
      irregular: "不规则",
      about_desc: "ConjuPuzzle 通过拼接动词词根与词尾的方式，引导法语学习者记住并掌握法语动词变位",
      author: "Created By",
      how_to_title: "如何使用",
      step_1_title: "阅读目标",
      ...
      tour_next: "下一步",
      tour_finish: "知道了",
      tour_header_title: "时态设置",
      tour_header_desc: "点击这个齿轮图标，你可以自由选择设置想要练习的时态。",
      tour_obj_title: "当前目标",
      ...
      tour_settings_desc: "选择和切换你想练习的时态（如：只练直陈式）。",
